...
export function getCloseButtonStyle(isHover: boolean): CSSProperties {
  return {
    ...
    ...(isHover ? settingsModalStyles.closeButtonHover : {}),
  };
}
...
export function getTabStyle(isActive: boolean, isHover: boolean): CSSProperties {
  if (isActive) {
    return {
      ...
      ...settingsModalStyles.tabActive,
    };
  }
  return {
    ...settingsModalStyles.tab,
    ...(isHover ? settingsModalStyles.tabHover : {}),
  };
}
...
export function getFormInputStyle(isFocus: boolean): CSSProperties {
  return {
    ...
    ...(isFocus ? settingsModalStyles.formInputFocus : {}),
  };
}
...
export function getButtonStyle(
  ...
  const baseStyle = {
    ...
    ...(variant === 'primary'
      ? settingsModalStyles.buttonPrimary
  ...
  if (isDisabled) {
    return {
      ...baseStyle,
      ...settingsModalStyles.buttonDisabled,
    };
  }

  return {
    ...baseStyle,
    ...(isHover ? settingsModalStyles.buttonHover : {}),
  };
}

export function getAiConnectionStatusStyle(status: 'idle' | 'testing' | 'success' | 'error' | 'saving'): CSSProperties {
  const baseStyle = settingsModalStyles.aiConnectionStatus;
  
  if (status === 'success') {
    return {
      ...baseStyle,
      ...settingsModalStyles.aiConnectionStatusSuccess,
    };
  }
  ...
  if (status === 'error') {
    return {
      ...baseStyle,
      ...settingsModalStyles.aiConnectionStatusError,
    };
  }
